...
const MillingStatement = () => {
  return (
    <section>
      <div style={{ display: "flex" }} className="outturn-head">
        <span className="outturn-season">
          <select>
        ...
        <span>
          <button className="search-outturns">SEARCH</button>
        </span>
      </div>

      <div className="grn-accordions">
        <Accordion />
        {/* add material ui  here */}
      </div>

      <div className="outturn-wrapper">
        {/* outturn table 1 */}
        <div className="outturn-table">
          <nav className="outturn-nav">
            <div className="OG">
              <button>
...
export default MillingStatement;
